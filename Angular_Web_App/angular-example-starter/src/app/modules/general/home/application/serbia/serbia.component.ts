...
@Component({
  selector: 'app-serbia',
  templateUrl: './serbia.component.html',
  styleUrls: ['./serbia.component.css']
})
export class SerbiaComponent implements OnInit {
  // declare variable 
...
filter: FilterModel;
  ...
  ngOnInit(): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Serbia","Superliga","Superliga 20/21",10,1))
        .subscribe(
          (data:any)=>{
  ...
  pageChanged(event: any): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Serbia","Superliga","Superliga 20/21",10,this.currentPage))
        .subscribe(
          (data:any)=>{
            this.data_Oddanalysis=data.objects;
            this.totalItem = data.totalItem;
