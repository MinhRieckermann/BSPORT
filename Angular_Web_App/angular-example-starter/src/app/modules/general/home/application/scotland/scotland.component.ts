...
@Component({
  ...
  styleUrls: ['./scotland.component.css']
})
...
filter: FilterModel;
  ...
  ngOnInit(): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Scotland","Premiership","Premiership 20/21",10,1))
        .subscribe(
          (data:any)=>{
  ...
  pageChanged(event: any): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Scotland","Premiership","Premiership 20/21",10,this.currentPage))
        .subscribe(
          (data:any)=>{
            this.data_Oddanalysis=data.objects;
            this.totalItem = data.totalItem;
