...
filter: FilterModel;
  ...
  ngOnInit(): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Mexico","Liga MX, Apertura","Primera Division, Apertura 2020",10,1))
        .subscribe(
          (data:any)=>{
  ...
  updateControls(): void {
    this.exampleForm.patchValue({
      ...
      season: 'Primera Division, Apertura 2020',
      TypeBet: 'Handicap',
      Match: null,
      Home:null,
      HomeOdd:null,
  ...
  pageChanged(event: any): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Mexico","Liga MX, Apertura","Primera Division, Apertura 2020",10,this.currentPage))
        .subscribe(
          (data:any)=>{
            this.data_Oddanalysis=data.objects;
            this.totalItem = data.totalItem;
