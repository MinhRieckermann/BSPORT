...
filter: FilterModel;
  ...
  ngOnInit(): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Ecuador","LigaPro Serie A, Segunda Etapa","LigaPro Serie A, Segunda Etapa 2020",10,1))
        .subscribe(
          (data:any)=>{
  ...
  updateControls(): void {
    this.exampleForm.patchValue({
      country: 'Ecuador',
      tournament: 'LigaPro Serie A, Segunda Etapa',
      season: 'LigaPro Serie A, Segunda Etapa 2020',
      TypeBet: 'Handicap',
  ...
  pageChanged(event: any): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Ecuador","LigaPro Serie A, Segunda Etapa","LigaPro Serie A, Segunda Etapa 2020",10,this.currentPage))
        .subscribe(
          (data:any)=>{
            this.data_Oddanalysis=data.objects;
            this.totalItem = data.totalItem;
