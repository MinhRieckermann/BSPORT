...
filter: FilterModel;
  ...
  ngOnInit(): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Portugal","Primeira Lig","Primeira Liga 20/21",10,1))
        .subscribe(
          (data:any)=>{
  ...
  updateControls(): void {
    this.exampleForm.patchValue({
      country: 'Portugal',
      tournament: 'Primeira Lig',
      season: 'Primeira Liga 20/21',
      TypeBet: 'Handicap',
      Match: null,
      Home:null,
      HomeOdd:null,
  ...
  pageChanged(event: any): void {
    ...
    this.oddAnalysisService
        .GetlistOdd_Analysis(AppSettings.GetQueryOddModel("Portugal","Primeira Lig","Primeira Liga 20/21",10,this.currentPage))
        .subscribe(
          (data:any)=>{
            this.data_Oddanalysis=data.objects;
            this.totalItem = data.totalItem;
