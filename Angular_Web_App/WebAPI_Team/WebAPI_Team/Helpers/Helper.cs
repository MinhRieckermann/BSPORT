    ...
    public class Helper
    {
        ...
        public static int SendEmail(QuerySearchModel query)
        {
            try
            {
                ...
                string CF_SMTP_ACC = "minh.tv@rieckermann.com";
                ...
                MailAddress copy = new MailAddress("minh.tv@rieckermann.com");

                Thread sm = new Thread(delegate ()
                {
                    using (var message = new MailMessage(CF_SMTP_ACC, "minh.tv@rieckermann.com")
                    {
