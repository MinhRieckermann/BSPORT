        ...
        
{
        ...
        // get Data with Specifing 2 parameter Country and week
        [System.Web.Http.HttpPost]
        [System.Web.Http.Route("GetlistOdd_Analysis_Country_Week")]
        public HttpResponseMessage GetlistOdd_Analysis_Country_Week(QueryOddModel_C_W model)
        {

            OddAnalysisService oddService = new OddAnalysisService(unitOfWork);
            var result = oddService.GetListOddAnalysis_Country_week(model.country,model.Week);
