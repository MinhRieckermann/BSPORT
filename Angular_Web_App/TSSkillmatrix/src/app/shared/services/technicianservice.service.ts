...
export class TechnicianService {
  ...
  SearchRegTechByName(query: QuerySearch) {
    var body = JSON.stringify(query);
    return this.http.post(
      this.rootUrl + "/api/technician/SearchRegTechByName",
      body,
  ...
  ConfirmActionListRegister(listRegister: Array<Technician>,isApp:boolean){
    var body = JSON.stringify(listRegister);
    if(isApp){
      return this.http.post(
        this.rootUrl + "/api/technician/ApproveListRegister",
        body,
        { headers: { "Content-Type": "application/json" } }
      );
    }
    return this.http.post(
      this.rootUrl + "/api/technician/RejectListRegister",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }
  ...
  CountRegisterForm(){
    return this.http.post(
      this.rootUrl + "/api/technician/CountRegisterForm",
      { headers: { "Content-Type": "application/json" } }
    );
  }
  ...
  AddListTechnicianSkill(technician: Technician[]) {
    var body = JSON.stringify(technician);
    return this.http.post(
      this.rootUrl + "/api/technician/AddListTechnicianSkill",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }

  RegisterTechnicianSkill(technician: Technician) {
    var body = JSON.stringify(technician);
    return this.http.post(
      this.rootUrl + "/api/technician/RegisterTechnicianSkill",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }
  ...
  UpdateRegTechnicianSkill(technician: Technician) {
    var body = JSON.stringify(technician);
    return this.http.post(
      this.rootUrl + "/api/technician/UpdateRegTechnicianSkill",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }
  ...
  GetListEmployeeBasedOnCountry(query: QuerySearch){
    var body = JSON.stringify(query);
    return this.http.post(
      this.rootUrl + "/api/technician/GetListEmployeeBasedOnCountries",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }

  SearchListEmployeeBasedOnCountry(query: QuerySearch){
    var body = JSON.stringify(query);
    return this.http.post(
      this.rootUrl + "/api/technician/SearchUserInititalByCountry",
      body,
  ...
  GetListRegister(query: QuerySearch) {
    var body = JSON.stringify(query);
    return this.http.post(
      this.rootUrl + "/api/technician/GetListRegisters",
      body,
      { headers: { "Content-Type": "application/json" } }
    );
  }
